...
const PROPS = ['username', 'name', 'hostmask', 'points_day', 'quests_day', 'points_week', 'quests_week', 'points_month', 'quests_month', 'points_made', 'num_answered', 'created', 'last_updated'];
